...
Stable external power supply for the modem
Jumper wires
Wiring
...
UART-based peripheral integration
Cellular modem bring-up
AT command sequencing
IoT protocol integration
Debug-oriented firmware design
Next Improvements
Add reconnect logic if the network drops
Parse responses more robustly instead of using string matching only
Move secrets into a separate config file
Add HTTP GET support
Add telemetry payloads in JSON format
